...
class Line < GeometryValue
  ...
  def intersectPoint(point)
    point.intersectLine self # avoid code duplication
  end
...
class VerticalLine < GeometryValue
  ...
  def intersectLine line
    line.intersectVerticalLine self # avoid code duplication
  end

  def intersectPoint(point)
    point.intersectVerticalLine self # avoid code duplication
  end
...
class LineSegment < GeometryValue
  ...
  def intersectPoint pnt
    pnt.intersectLineSegment self # avoid duplication
  end

  def intersectLine line
    line.intersectLineSegment self # avoid duplication
  end
